...
- **Tier-gated memory surfaces (project-init ADR-024; project-init ADR-025 §4).** `vault_path`, `graph_path`,
...
this surface-independent inventory (project-init ADR-017 §6) of the skills, hooks, and MCP
